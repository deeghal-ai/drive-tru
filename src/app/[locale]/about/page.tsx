...
const translations = {
  en: {
    ...
    heroSubtitle: 'Drive Tru is the pre-owned vehicle division of Al Rostamani Trading Company, bringing you certified quality vehicles with complete peace of mind.',
    stat1: 'Happy Customers',
    stat2: 'Satisfaction Rate',
    stat3: 'Showrooms in UAE',
    stat4: 'Years of Excellence',
    storyTitle: 'Our Story',
    storyP1: 'Drive Tru was born from a simple vision: to transform the pre-owned car buying experience in the UAE. As part of the Al Rostamani Group, we bring decades of automotive expertise and a commitment to excellence.',
    ...
    storyP3: 'Today, Drive Tru stands as the premier destination for quality pre-owned Suzuki, Citroen, and select multi-brand vehicles in the UAE, with showrooms across Dubai and Abu Dhabi.',
    ...
    whyChooseTitle: 'Why Choose Drive Tru?',
    ...
    testimonial2: 'Excellent service! The team went above and beyond to help me find the perfect family SUV. Highly recommend Drive Tru.',
